...
    if (!clickedTab.classList.contains('tab-btn')) { return; }
...
    const warningEl = document.getElementById('domainFillWarning'); // 获取动态提示/警告元素
    const domainValueTrimmed = domainValue.trim(); // 当前输入的域名
    const originalDomain = document.getElementById('editOriginalDomain').value; // 编辑模式下的原域名
